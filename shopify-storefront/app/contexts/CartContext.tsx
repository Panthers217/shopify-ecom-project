...
/**
 * CartProvider - Provides cart state and methods to all child components
 *
 * Features:
 * - Uses Shopify Storefront API (designed for custom apps)
 * - Backend proxies requests with proper authentication
 * - Real-time cart state updates across all components
...
/**
 * useCart - Hook to consume cart context
 * 
